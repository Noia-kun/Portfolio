...
- **Tailwind CSS v4**
- **Vite**
- **Motion** & **GSAP** — text and interaction animations
- **EmailJS** — contact form email delivery
- **Google reCAPTCHA v2** — spam protection on the contact form
- **react-github-calendar** — GitHub contribution heatmap
- **@thesvg/react** & **@heroicons/react** — brand logos and UI icons

## Design

A dark obsidian/cyan aesthetic (with a full light theme, plus a system-preference mode) inspired by Modal.com's phosphor-terminal component system — code-window cards, hairline borders, and a single rationed accent color. Neon Cyan is the sole accent throughout, tuned separately per theme for consistent contrast.

## Author

**Richwelle Rod Roxas Remetio**
[GitHub](https://github.com/Noia-kun) · [LinkedIn](https://www.linkedin.com/in/richwellerodremetiorr/)

## Credits

Several animations and UI patterns were adapted from [React Bits](https://reactbits.dev) and [Uiverse.io](https://uiverse.io) — huge thanks to both communities for the inspiration.